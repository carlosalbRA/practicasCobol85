      ...
      * --------------   VARIABLES DE TRABAJO  -------------------
	   ...
	   01  WKS-SUM-COM                   PIC 9(07)V99.
	   01  WKS-TOT-COM-N                 PIC 9(07)V99.
       01  WKS-RES                       PIC X.
       01  WKS-WAIT                      PIC X.
      ...
      * --------------   VARIABLES DE REPORTE  --------------------
       ...
       01  WKS-ENC-3.
		 ...
		 03 FILLER                PIC X(05)   VALUE SPACES.
		 03 FILLER                PIC X(10)   VALUE "TOTAL COM ".

       01  WKS-DET-1.
        03 FILLER                PIC X(05)   VALUE SPACES.
        03 WKS-CLAVE             PIC 9(03).
        03 FILLER                PIC X(07)   VALUE SPACES.
        03 WKS-NOMBRE            PIC X(30).
        03 FILLER                PIC X(04)   VALUE SPACES.
        03 WKS-VTAS              PIC $ZZ,ZZZ.99.
		03 FILLER                PIC X(11)   VALUE SPACES.
		03 WKS-POR-COM           PIC Z9.
		03 FILLER                PIC X(09)   VALUE SPACES.
		03 WKS-TOT-COM           PIC $ZZ,ZZ9.99.

       01  WKS-TOT-1.
        03 FILLER               PIC X(11)   VALUE SPACES.
        03 FILLER               PIC X(38)   VALUE
                     "TOTAL DE VENTAS MENSUALES Y COMISION: ".
        03 WKS-TOT-EDIT         PIC $ZZZ,ZZZ.99.
		03 FILLER               PIC X(20) VALUE SPACES.
		03 WKS-SUM-COM-E          PIC $ZZZ,ZZZ.99.
	   
	   01  WKS-LIN-FIN.
		03 FILLER PIC X(05) VALUE SPACES.
		03 FILLER PIC X(86) VALUE ALL "-".
      ...
      **  DETALLE ARCHIVO **
		   ...
		   PERFORM 200250-CALCULAR-COMISION.	
	   ...
	   200250-CALCULAR-COMISION.	
			 IF VTAS-TOTALES < 5000
				MOVE 0 TO WKS-POR-COM
				MULTIPLY 0 BY VTAS-TOTALES 
				GIVING WKS-TOT-COM-N
			ELSE 
				IF VTAS-TOTALES >= 5000 
				   AND VTAS-TOTALES <= 15000
					MOVE 5 TO WKS-POR-COM
					MULTIPLY 0.05 BY VTAS-TOTALES 
					GIVING WKS-TOT-COM-N
				ELSE 
					IF VTAS-TOTALES > 15000 
					    AND VTAS-TOTALES <= 25000
						MOVE 10 TO WKS-POR-COM
						MULTIPLY 0.1 BY VTAS-TOTALES 
						GIVING WKS-TOT-COM-N
					ELSE
						IF VTAS-TOTALES > 25000 
						   AND VTAS-TOTALES <= 35000
							MOVE 15 TO WKS-POR-COM
							MULTIPLY 0.15 BY VTAS-TOTALES 
							GIVING WKS-TOT-COM-N
						ELSE
							MOVE 20 TO WKS-POR-COM
							MULTIPLY 0.2 BY VTAS-TOTALES 
							GIVING WKS-TOT-COM-N.
		
		MOVE WKS-TOT-COM-N TO WKS-TOT-COM.
	    ADD WKS-TOT-COM-N TO WKS-SUM-COM.
      *
       200300-TERMINA-GEN-REP.
      *--------------------
           MOVE WKS-TOTAL        TO  WKS-TOT-EDIT.
		   MOVE WKS-SUM-COM      TO  WKS-SUM-COM-E.
